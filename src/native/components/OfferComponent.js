...
import { cardItem, matchItemList, allOffers } from '../data/offerComponentData';
                    ...
                    filterButtonNames.map((item, index) => {
                      return (
                        <TouchableOpacity
                          ...
                          key={index}
                        >
                          <View style={item.state === true ? styles.selectedButton : styles.unSelectedButton}>
                            <FeatherIcon 
                              name="check" 
                              size={15} 
                              style={item.state === true ? styles.selectedButtonCheck : styles.unSelectedButtonCheck}
                            />
                            <Text style={item.state === true ? styles.selectedButtonText : styles.unSelectedButtonText}>
                              {item.name}
                            </Text>
                          </View>
                        </TouchableOpacity>
